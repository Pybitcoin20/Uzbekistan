  ...
  return (
    <section id="guide" className="py-24 bg-cotton dark:bg-zinc-950 relative">
      <div className="container mx-auto px-6">
        ...
        <div className="mt-12 p-8 rounded-3xl bg-samarkand text-white flex flex-col md:flex-row items-center gap-8 shadow-2xl shadow-samarkand/20">
          ...
          <button className="px-8 py-4 bg-white text-samarkand rounded-2xl font-bold text-sm whitespace-nowrap hover:bg-silk hover:text-white transition-all">
            Full Legal Guide
          </button>
        </div>
      </div>
